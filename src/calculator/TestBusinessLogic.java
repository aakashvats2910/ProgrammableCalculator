 ...
 * 
 * @version 4.00	2018-01-29 Added the sub, mpy and div method which perform the required computations.
 * @version 5.00    2019-02-19 Aakash Sharma tested the methods so that it properly works. 
 *                             Aakash Sharma added the log method to calculate the log base 2
 *                             
 * @version 6.00    2019-03-20 Aakash Sharma added the FSM code 
 * 							   Aakash Sharma added the functioning of FSM and declared all the variables needed to run the FSM.
 *                             The code of the FSM has been taken from the W8D3 Study Hall Activity.
 *                             
 * @version 7.00    2019-03-25 Aakash Sharma work on the UI of the Calculator and FSM.
 *                             Add the code in the Error term operands
 *
 * @version 8.00    2019-10-23 Aakash Sharma work on the UI of the Calculator and the UNumber in this previous version .
 *                            Add the code for using the UNumber code in calculator.                              
 */
...
public class TestBusinessLogic {
	...
	public static void main(String[] args) {
		...
		flag = test.setOperand2("1234560123456789", "1234560123456789");							// Perform the test
		...
		flag = test.setResult("1234560123456789","1234560123456789");							// Perform the test
		...
		test.setOperand1("1234560123456789","1234560123456789");

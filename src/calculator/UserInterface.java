 ...
 *
 * @version 7.00 2019-03-25 Aakash Sharma work on the UI of the calculator with
 *          error term and also add the button of the A� and button of A� add
 *          the function square root and the function of the Power on the both
 *          of the buttons.
 *
...
public class UserInterface {
	...
	private Button button_new = new Button("New");
	...
	public UserInterface(Pane theRoot) {
		...
		theRoot.getChildren().addAll(label_IntegerCalculator, label_Operand1, text_Operand1, label_errOperand1,
				...
				unitboxOperand2, unit_Operand_Result, label_Units, label_Unit1, label_Unit2, viewButton);
	}

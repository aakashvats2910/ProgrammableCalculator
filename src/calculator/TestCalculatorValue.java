...
public class TestCalculatorValue {
	...
	public static void main(String[] args) {
		...
		// 5. Perform addition
		CalculatorValue left = new CalculatorValue();						// Set up the test
		CalculatorValue right = new CalculatorValue();
		...
		left = new CalculatorValue();										// Set up the test
		right = new CalculatorValue();
